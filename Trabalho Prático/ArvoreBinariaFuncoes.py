...
print("Contagem de nós na árvore: ", contagemNos(n))
print("Maior valor na árvore: ", maiorValor(n))
print("Procurando o valor 21 na árvore: ", procuraN(n, 21))
print("Procurando o valor 7 na árvore: ", procuraN(n, 7))
